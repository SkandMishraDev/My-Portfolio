    ...
    <div className='p-8 bg-gray-100'>
      ...
      <div className='flex flex-col md:flex-row md:space-x-8'>
        ...
        <div className='md:w-1/2 '>
          <img
            src='https://res.cloudinary.com/dgktguczj/image/upload/v1729360422/MY-portfolio/i0gtmrzodzmwjrdackxp.jpg' // Replace with your image URL
            alt='Skand Mishra'
            className='w-96 h-132 object-cover rounded-lg shadow-lg'
          />
        </div>
      </div>
